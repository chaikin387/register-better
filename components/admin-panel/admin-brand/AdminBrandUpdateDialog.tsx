...
import { updateBrandSchema, type UpdateBrandInput } from './update-brand.schema'
...
export function AdminBrandUpdateDialog({
  isOpen,
  brand,
  onClose,
  onSuccess,
  ...
  function onSubmit(values: UpdateBrandInput) {
    startTransition(async () => {
      const result = await updateAdminBrand(values)
