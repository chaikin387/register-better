...
export function HeaderClient({ session, categories }: Props) {
  ...
  return (
    <header className='sticky top-0 z-50 border-b bg-background'>
        ...
        >
          ...
          >
            ...
            <SheetContent
              ...
              className='fixed inset-x-0 top-16 bottom-0 overflow-y-auto border-t bg-popover'
            >
      ...
      {isPending && (
        <div className='fixed inset-x-0 top-16 bottom-0 z-999 bg-popover' />
      )}
    </header>
  )
}
